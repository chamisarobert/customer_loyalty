...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheProductsList.onFilterBar().iCheckFilterField("Name");
        });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsList.onTable().iCheckColumns(3, {"name":{"header":"Name"},"description":{"header":"Description"},"price":{"header":"Price"}});
