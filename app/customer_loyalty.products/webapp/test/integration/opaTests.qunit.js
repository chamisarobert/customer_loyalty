...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "customerloyalty/products/test/integration/FirstJourney",
    "customerloyalty/products/test/integration/ProductsListJourney",
    "customerloyalty/products/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
